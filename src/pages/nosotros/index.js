              ...
              <div className="columns is-centered is-mobile"> 
                  <div className="column">
                    ...
                    <p className="is-size-5" style={{padding: "1.5em"}}>
                      ...
                      <br /><br />
                      Esperamos que les gusten las recetas y si tienen cualquier duda o comentario no duden en ponerse en contacto con nosotros. Nos pueden escribir en la página de <Link to="/contacto">contacto</Link> o en nuestro <a href="https://www.instagram.com/lumoncooks/" target="_blank" rel="noopener noreferrer">Instagram</a>.
                    </p>
                    <br />
                  </div>            
              </div>             
